...
class Lab5Window(QWidget):
    def __init__(self, parent=None):
        ...
        g1   = QVBoxLayout(grp1)
        g1.addWidget(self._btn("1.3.1  Передаточная характеристика ОУ",          "131"))
        g1.addWidget(self._btn("1.3.2  Зависимость Umax(вых) от тока Iвых",      "132"))
        g1.addWidget(self._btn("1.3.3  Напряжение смещения ОУ",                  "133"))

        grp2 = QGroupBox("Часть 2. Усилители на ОУ")
        g2   = QVBoxLayout(grp2)
        g2.addWidget(self._btn("2.3.1  Зависимость Ku НУ от R4",                 "231"))
        g2.addWidget(self._btn("2.3.2  Передаточная характеристика НУ",          "232"))
        g2.addWidget(self._btn("2.3.3  Передаточная характеристика повторителя", "233"))
        g2.addWidget(self._btn("2.3.4  Передаточная характеристика ИУ (=)",      "234"))
        g2.addWidget(self._btn("2.3.5  Исследование ИУ на переменном токе",      "235"))
